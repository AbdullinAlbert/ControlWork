...
public class FillNewData_Activity extends AppCompatActivity implements ActivityResultCaller {
    ...
    static final String ITEM_FROM_DB = "get_item_from_db";
    static final String ID_FROM_DB = "get_id";
    static final String LAUNCH_DEFINITELY_DB = "launch_definitely_db";
    ...
    private void launchActivutyForResult(int i) {
        Intent intent = new Intent(FillNewData_Activity.this, ListOfEmplActivity.class);
